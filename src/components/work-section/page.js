...
export default function WorkSection() {
  return (
    <div className="mx-4 sm:mx-8 md:mx-16 grid grid-cols-1 sm:grid-cols-2 gap-x-8 sm:gap-x-14 gap-y-12 sm:gap-y-24 md:gap-y-48 items-center">
      ...
      <WorkCard side={'left'} imgSrc={CodeUtsava.src} heading={"Tomorrow"} caption={
